class MachineLearningImagesTfjs {
    ...
    constructor() {
        this._labels = {
            items : [  'Samsung',  'Huawei',  'Apple',  'Xiaomi',  ],
        ...
        var encodedProjectData = JSON.stringify({
            ...
            projectid : '6a86fe208a0711eeb9b411761ad0bdbc',
            storage: 'cloud'
        });
        postMessage({
            mlforkidsimage : {
    ...
    getInfo() {
        ...
        return {
            ...
            id: 'mlforkidsimages6a86fe208a0711eeb9b411761ad0bdbc',
            ...
            blocks: [
                ...
                {
                    opcode: 'return_label_2',
                    blockType: Scratch.BlockType.REPORTER,
                    text: ' Apple'
                },
                {
                    opcode: 'return_label_3',
                    blockType: Scratch.BlockType.REPORTER,
                    text: ' Xiaomi'
                },
    ...
    addTraining({ TEXT, LABEL }) {
        ...
        var url = new URL('https://machinelearningforkids.co.uk/api/scratch/341005d0-8a0c-11ee-b9b4-11761ad0bdbc528c474f-c8ca-4570-82c1-629dfd606e5f/train');
    ...
    receiveListenEvents (msg, that) {
        if (msg && msg.data && msg.data.mlforkidsimage && msg.data.data.projectid == '6a86fe208a0711eeb9b411761ad0bdbc')
        {
    ...
    _getTrainingData() {
        var urlstr = 'https://machinelearningforkids.co.uk/api/scratch/341005d0-8a0c-11ee-b9b4-11761ad0bdbc528c474f-c8ca-4570-82c1-629dfd606e5f/train?proxy=true';
